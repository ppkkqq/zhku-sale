    ...
    <div class="myorder-main container">
      <div class="order-main">
        <div class="order-head">
          ...
          <div class="head-item" style="width: 120px">起始时间</div>
          <div class="head-item" style="width: 120px">结束时间</div>
          <div class="head-item" style="width: 120px">操作</div>
        </div>
        <div class="empty-box" v-if="isEmpty">暂无数据</div>

        <div class="order-section" v-for="(pItem, index) in productList" :key="index">
          <div class="order-list">
            ...
            <div class="order-item-box">
              <span class="text">{{pItem.starttime}}</span>
            </div>
            <div class="order-item-box">
              <span class="text">{{pItem.lasttime}}</span>
            </div>
            <div class="order-item-box">
              <p class="text">
